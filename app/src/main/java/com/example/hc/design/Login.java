...
txt1=(TextView)findViewById(R.id.txt1);
        ...
        Cursor cursor = mEmailsDb.rawQuery("select DISTINCT tbl_name from sqlite_master where tbl_name ='" + DB_TABLE + "'", null);
        //创建数据库
        if (cursor != null) {

            if (cursor.getCount() == 0) //无数据表
                mEmailsDb.execSQL("CREATE TABLE " + DB_TABLE + "(" +
                        "email TEXT NOT NULL ," +
                        "password TEXT);");
            cursor.close();
        }
    ...
    public void attemptLogin() {
        ...
        emaill=mEmailView.getText().toString();
        ...
        if(x==1) {
            ...
            newRow.put("email", email.toString());
            newRow.put("password", password.toString());

            mEmailsDb.insert(DB_TABLE, null, newRow);
            Intent intent = new Intent(Login.this, Loginqueren.class);
            ...
            c=mEmailsDb.query(true, DB_TABLE,new String[]{"email","password"}, "email="+"\""+email+"\"",
